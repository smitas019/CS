...
public class StaticDataStore {
	...
	static List<Post> newsFeedsList = new ArrayList<Post>();
	static {
		try {
	...
	public static void setUsers(Set<User> users) {
		StaticDataStore.users = users;
	}

	/**
	 * @return the sdformat
	 */
	public static SimpleDateFormat getSdformat() {
		return sdformat;
	}

	/**
	 * @param sdformat the sdformat to set
	 */
	public static void setSdformat(SimpleDateFormat sdformat) {
		StaticDataStore.sdformat = sdformat;
	}
